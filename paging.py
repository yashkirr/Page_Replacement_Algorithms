...
# Usage: python paging.py [Frame size] [Number of Pages]
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python paging.py [Frame Size] [Length of Reference String]") # Usage example python paging.py 5 64
    else:
        main()
